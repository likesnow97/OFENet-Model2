...
def construct_image_path(row, raf_path):
    ...
    if dataset == 'casme2':
        ...
        #     sub_num = subject[3:]  # 从'sub01'中提取'01'
        # else:
        #     sub_num = str(subject).zfill(2)
...
def precompute_flows(csv_path, raf_path, output_dir, overwrite=False):
    ...
    # 6. 保存新的数据表
    output_csv = os.path.join(output_dir, 'dataset_with_tvl1_flows_224.csv')
...
if __name__ == '__main__':
    ...
    # 3. 输出目录
    OUTPUT_DIR = '/nfs/users/yanghuiru/AMER/dataset/3DB/precomputed_tvl1_flows_224'
